...
<head>
  ...
  <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css', 'resources/js/editor.js', 'resources/js/app.js']); ?>
</head>
...
<?php endif; ?>
  ...
  <div x-data="articleEditor()"
       x-cloak
       data-tags='<?php echo json_encode($tags, 15, 512) ?>'
       data-initial-selected='<?php echo json_encode([], 15, 512) ?>'
       data-note-id=""
       data-initial-cover=""
       data-server-errors='<?php echo json_encode(isset($errors) ? $errors->all() : [], 15, 512) ?>'
       data-autosave-url="<?php echo e(route('notes.autosave')); ?>"
       data-update-url="<?php echo e(route('notes.update', '__ID__')); ?>"
       data-create-category-url="<?php echo e(route('categories.store')); ?>"
       data-upload-image-url="<?php echo e(route('notes.upload-image')); ?>">
    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 pt-6 pb-28">
      ...
      <div class="flex items-center justify-between mb-6">
        <nav class="flex items-center gap-2 text-sm text-text-secondary">
          <a href="<?php echo e(route('dashboard')); ?>" class="hover:text-primary transition">Dashboard</a>
      ...
      <form x-ref="form" action="<?php echo e(route('notes.store')); ?>" method="POST"
        ...
        <div class="card-editor">
          ...
          <?php echo $__env->make('components.markdown-toolbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="mt-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div class="flex items-center gap-3">
            <a href="<?php echo e(route('dashboard')); ?>" class="btn-ghost">取消</a>
    ...
    <?php echo $__env->make('components.image-insert-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
  </div>

  <?php echo $__env->make('components.article-editor-script', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</body>
</html>
<?php /**PATH /Volumes/T7/Project/blog/resources/views/notes/create.blade.php ENDPATH**/ ?>