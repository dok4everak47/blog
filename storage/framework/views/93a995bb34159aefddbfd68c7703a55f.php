...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-12 bg-bg">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="rounded-2xl border border-border bg-surface-2 p-5 sm:p-6" x-data="aboutEditor(<?php echo e(Illuminate\Support\Js::from($aboutHtml)); ?>)">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="<?php echo e(route('about')); ?>" target="_blank" class="text-xs text-primary hover:text-primary-hover transition flex items-center gap-1">
                            预览页面
