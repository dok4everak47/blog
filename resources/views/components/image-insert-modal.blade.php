{{-- 插入图片弹窗：同时支持「上传本地图片」与「粘贴图片链接」
     依赖父级 x-data="articleEditor()" 中的状态与方法：
     - imageModalOpen / imageUrl / imageAlt / imageUploading
     - openImageModal / closeImageModal / uploadInlineImage / confirmImageInsert --}}
