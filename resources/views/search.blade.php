    ...
    <div class="mb-10">
      ...
      <form action="{{ route('search') }}" method="GET" class="relative">
        <input type="text" name="q" value="{{ $q }}" autofocus
               ...
               class="w-full rounded-xl border border-border bg-surface-2 px-5 py-3.5 pr-12 text-sm text-text outline-none transition focus:border-primary focus:bg-white focus:ring-2 focus:ring-primary/10">
