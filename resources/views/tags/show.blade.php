...
@section('seo')
<meta name="description" content="{{ $tag->name }} 标签下的所有文章 — {{ config('app.name', 'My Blog') }}">
<meta property="og:type" content="website">
<meta property="og:title" content="标签：{{ $tag->name }}">
<meta property="og:url" content="{{ route('tags.show', $tag) }}">
@endsection
